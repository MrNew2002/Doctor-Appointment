...
import DoctorList from '../compoments/Doctors/DoctorList';
import Faqlist from '../compoments/Faq/Faqlist';
...
const Home = () => {
  return (
    <>
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flew-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              [100px] md:left-5 z-20 p-2 pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[10px] text-[8px]
